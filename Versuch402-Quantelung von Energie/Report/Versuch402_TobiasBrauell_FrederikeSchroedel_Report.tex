...
%         Frequenz des Lichts, aber nicht von der Intensität abhängt.
      ...
      \begin{subsection}{Photozelle}
        ...
        \begin{figure}[b]
          \begin{center}
            ...
            \caption{Schematischer Aufbau einer Photozelle. \cite{bib:PhotozelleAufbau}}
  ...
  \begin{chapter}{Weiterführende Überlegungen}
    ...
    \begin{section}{Zusätzliche Spektrallinien}
      ...
      Die Balmerlampe ist nicht mit Wasserstoffatomen gefüllt, da sich diese sofort zu Wasserstoffmolekülen verbinden würden und man dann die Linien das Moleküls betrachten würde. Statt dessen ist sie mit Wasserdampf gefüllt, welcher durch elektrische Entladung in Wasserstoffatome und OH-Radikale aufgespalten wird. Somit liegt in der Lampe neben dem Wasserstoffatomen auch Wassermoleküle und OH-Radikale, welche angeregt werde können und somit Spektrallinien verursachen können.  
  ...
  \begin{thebibliography}{99}
    ...
    \bibitem{bib:Balmerlampe-uni-stuttgart}\url{www.ipc.uni-stuttgart.de/demokurs/Balmer-Serie.pdf}
    \bibitem{bib:Linienbreite}\url{de.wikipedia.org/wiki/Linienbreite}
    \bibitem{bib:Linineverbreiterung}\url{de.wikipedia.org/wiki/Linienverbreiterung}
\bibitem{bib:Dopplerverbreiterung}\url{de.wikipedia.org/wiki/Dopplerverbreiterung}
