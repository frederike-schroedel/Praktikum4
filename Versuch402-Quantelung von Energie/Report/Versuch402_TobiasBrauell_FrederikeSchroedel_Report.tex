...
%   \setcounter{page}{2}
  ...
  \begin{chapter}{Versuchsaufbau und Durchführung}
    ...
    \begin{section}{Aufbau und Justage}
      ...
      \todo[inline]{skizze}
      Wie in der Skizze zu sehen besteht der Aufbau aus einer Hg Lampe, einer Blende, einer Linse, dem Filterrad und der Photozelle. Man nutzt eine Hg-Lampe, da diese bereits ein diskretes Spektrum hat, so dass Filter, die einige Nanometer um dem Bereichen der Emissionslinien liegen, ausreichend sind um einen genügend scharfen Wellenlängen Bereich zu nutzen. 
    % Das dient dazu, die in der Photozelle befindliche Kathode mit Licht verschiedener Frequenzen beleuchten zu können.
      Bei dem Aufbau ist wichtig das alle Bauteile so positioniert sind, dass die in der Photozelle befindliche Kathode mit Licht verschiedener Frequenzen beleuchtet wird. Zunächst ist zu beachten das die Bauteile in der oben genannten Reihenfolge auf der gleichen Höhe angeordnet sind.
      Hierzu wir die 
      Nun ist
