...
%   \setcounter{page}{2}
  ...
  \begin{chapter}{Erster Versuchsteil - Photoeffekt}
    ...
    \begin{section}{Durchführung}
      ...
      \todo[inline]{Am besten hier noch schreiben dass unsere erste messung leicht verrutscht ist und wir die abschirmung mit transparentem haftreibungs verstaerker temporaer modifiziert haben}
