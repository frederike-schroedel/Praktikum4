...
%         Frequenz des Lichts, aber nicht von der Intensität abhängt.
    ...
    \begin{section}{Bohrsches Atommodell und Balmer-Serie}
      ...
      \begin{subsection}{Spektroskopie}
        ...
        Wir haben es hier mit der Spektroskopie an einem Reflextionsgitter zu
        tun.
        \begin{figure}[b]
          \begin{center}
  ...
  \begin{chapter}{Erster Versuchsteil - Photoeffekt}
    ...
    \begin{section}{Aufbau und Justierung}
      ...
      \begin{figure}[htbp]
        ...
        \end{center}
      \end{figure}
      Nach der Jusiterung des Aufbaus ist es wichtig die Photozelle richtig an
      ...
      zu $\SI{12}{\volt}$ liegt an den Spannungsteiler an, zwischen dessen
    ...
    \begin{section}{Durchführung}
      ...
      Wir haben aus den vorhandenen Widerständen (zwei mal $\SI{100}{\ohm}$,
      ...
      ist es zu einer großen Intensitätsdifferenz zwischen den beide
      aufgenommenen Kennlinien gekommen. Im Anschluss wird für die Wellenlänge
      $\lambda = \SI{365}{\nano\meter}$ die Intensität deutlich vergrößert und
    ...
    \begin{section}{Auswertung des ersten Versuchstages}
      ...
      um zu zeigen, dass die Grenzspannung unabhängig der Intensität ist und
      ausschließlich durch die Wellenlänge bestimmt wird. In
      ...
      Aus dem Y-Achsen Schnittpunkt der angepassten Geraden in 
      ...
      \cref{eq:Ekin} treffen. Der Schnittpunkt mit der Y-Achse entspricht 
  ...
  \begin{chapter}{Zweiter Versuchsteil - Balmer-Serie}
    ...
    \begin{section}{Aufbau}
      ...
      Hierzu nutzen wir ein Reflexionsgitter, welches zwischen zwei gewinkleten
    ...
    \begin{section}{Justierung und Durchführung}
      ...
      \begin{subsection}{Justierung}
        ...
        senkrecht stehenden Spaltes abbildet. Als nächstes wird das Objektiv
        eingesetzt und mit Hilfe der Autokollimation justiert. Das lässt sich
        realisieren, indem man das Gitter so dreht, dass die Reflexion erneut
        durch das Objektiv fällt und somit den Spalt neben den Spalt abbildet.
        Wenn man diese Abbildung des Spaltes nun scharf stellt, ist diese nach
        ...
        zweiten Armes wird das Okular so montiert, dass die Skala gut
      ...
      \begin{subsection}{Bestimmung der Gitterkonstante}
        ...
        wir, da sie eine hohe Intensität hat, wodurch die Spektrallinien gut
        ...
        ersten Linien im Okular sichtbar zu machen. Nun stellen wir mit Hilfe
      ...
      \begin{subsection}{Untersuchung der Balmer-Linie mit einem Okular}
        ...
        Linienbreite repräsentiert. Hierfür ist besonders wichtig die Linien
        ...
        \begin{table}[htbp]
          ...
          \caption{Messreihe zur Bestimmung der Wellenlängen der Balmer-Serie 
              mithilfe der H/D-Lampe. Mit einem Ablesefehler auf die Winkel 
              von $\SI{0.5}{\degree}$}
      ...
      \begin{subsection}{Untersuchung der Balmerlinie mit der CCD-Kamera}
        ...
        ersetzt. Dabei muss darauf geachtet werden, dass CCD-Zeile beleuchtet
        ...
        Isotopieaufspaltung messen, also suchen wir nach Ausschlägen, indem
        ...
        der Intensität und verschieben der letzten Linse zwei scharfe getrennte
    ...
    \begin{section}{Auswertung}
      ...
      \begin{subsection}{Bestimmung der Balmer-Linien mit dem Okular}
        ...
        Linienbreite lässt sich mit \cref{eq:Isotopieaufspaltung} die 
        Isotopieaufspaltung der Balmerlinien berechnen.
        \begin{equation}
          \label{eq:Isotopieaufspaltung}
          \Delta\lambda=\frac{dgcos(\beta)}{f}
        \end{equation}
        Wobei in \cref{eq:Isotopieaufspaltung} \textbf{d} die abgelesene 
      ...
      \begin{subsection}{Bestimmung des Planckschen Wirkungsquantum mit der
        ...
        Isotopieaufspaltung bestimmen. Leider erhalten wir bei unseren 
        Rechnungen dazu nur Ergebnisse der Isotopieaufspaltung im Bereich von
        ...
        Fehlersuche und mehrfach wiederholtem, neuen erstellen der Rechnungen 
        leider zu keinem sinnvollen Ergebnissen kommen. \\
        Theoretisch hätte aus der Isotopieaufspaltung nun die 
    ...
    \begin{section}{Fazit}
      ...
      erscheinen. Für den Teil mit der CCD-Kamera wiederum müssen wir davon 
  ...
  \begin{chapter}{Weiterführende Überlegungen}
    ...
    \begin{section}{Zusätzliche Spektrallinien}
      ...
      Die Balmerlampe ist nicht mit Wasserstoffatomen gefüllt, da sich diese 
      sofort zu Wasserstoffmolekülen verbinden würden und man dann die Linien 
      das Moleküls betrachten würde. Statt dessen ist sie mit Wasserdampf 
      gefüllt, welcher durch elektrische Entladung in Wasserstoffatome und 
      OH-Radikale aufgespalten wird. Somit liegt in der Lampe neben dem 
      Wasserstoffatomen auch Wassermoleküle und OH-Radikale, welche angeregt 
      werde können und somit Spektrallinien verursachen können.  
...
>>>>>>> frederike/master
    ...
    \begin{section}{Dopplerverbreiterung und Natürliche Linienbreite}
      ...
      \begin{subsection}{Vergleichen mit dem bestimmten Wert}
        ...
        Da bei der Bestimmung der Linienbreite etwas schief gegangen ist lassen 
        sie sich leider nicht sinnvoll mit den berechneten Werten vergleichen.
  ...
  %%%%%%%%%%%%%%%%%%%%
  \input{./Versuch402_TobiasBrauell_FrederikeSchroedel_Appendix.tex}
  %%%%%%%%%%%%%%%%%%%%
  ...
  \begin{thebibliography}{99}
    ...
    \bibitem{bib:Balmerlampe-uni-stuttgart}\url
        {www.ipc.uni-stuttgart.de/demokurs/Balmer-Serie.pdf}
    \bibitem{bib:Linienbreite}\url{de.wikipedia.org/wiki/Linienbreite}
    \bibitem{bib:Linineverbreiterung}\url
