...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{amsmath}
  \newcounter{mySubCounter2}
  \newcommand{\twoeqn}[2]{%
    \setcounter{mySubCounter2}{0}
    \let\OldTheEquation\theequation%
    \renewcommand{\theequation}{\OldTheEquation\alph{mySubCounter2}}%
    \noindent%
    \addtocounter{mySubCounter2}{1}%
  ...
  \newcounter{mySubCounter4}
  \newcommand{\foureqn}[4]{%
    \setcounter{mySubCounter4}{0}
    \let\OldTheEquation\theequation%
    \renewcommand{\theequation}{\OldTheEquation\alph{mySubCounter4}}%
    \noindent%
    \refstepcounter{mySubCounter4}
    \begin{minipage}{.48\textwidth}
    \begin{align}
    #1 \\
    \addtocounter{equation}{-1}
    \addtocounter{mySubCounter4}{2}
    #3
    \end{align}
    \end{minipage}%
    \addtocounter{equation}{-1}%
    \addtocounter{mySubCounter4}{-1}%
    \begin{minipage}{.48\textwidth}
    \begin{align}
    #2 \\
    \addtocounter{equation}{-1} 
